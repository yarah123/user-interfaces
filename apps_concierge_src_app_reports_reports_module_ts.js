...
class ReportsStateService {
  get _ignore_days() {
    ...
    return day_list?.map(_ => typeof _ === 'string' ? _?.toLowerCase() : (0,date_fns__WEBPACK_IMPORTED_MODULE_9__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_10__["default"])(new Date(), _), 'eeee')?.toLowerCase()).filter(_ => !!_);
  }
  get duration() {
