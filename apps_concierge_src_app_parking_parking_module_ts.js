...
class ParkingSpaceListComponent {
  ...
  static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
    ...
    decls: 11,
    vars: 20,
    consts: [["action_template", ""], [1, "absolute", "inset-0", "overflow-auto", "px-2"], [1, "block", "min-w-[56rem]", 3, "dataSource", "columns", "display_column", "column_size", "template", "filter"], ["class", "absolute bottom-0 inset-x-0", 4, "ngIf"], ["btn", "", "icon", "", "matRipple", "", 1, "absolute", "bottom-2", "left-2", "bg-secondary", "text-secondary-content", 3, "click"], [1, "w-full", "flex", "items-center", "justify-end"], ["icon", "", 3, "click"], [1, "absolute", "bottom-0", "inset-x-0"]],
    template: function ParkingSpaceListComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        let tmp_1_0;
        let tmp_8_0;
        const action_template_r5 = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵreference"](5);
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"]();
...
function ParkingTopbarComponent_date_options_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("dateChange", function ParkingTopbarComponent_date_options_7_Template_date_options_dateChange_0_listener($event) {
      ...
      return _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵresetView"](ctx_r2.setDate($event));
    });
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]();
  }
}
class ParkingTopbarComponent extends _placeos_common__WEBPACK_IMPORTED_MODULE_1__.AsyncHandler {
  ...
  static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineComponent"]({
    ...
    decls: 8,
    vars: 5,
    consts: [[1, "flex", "items-center", "bg-base-100", "px-2", "h-20"], ["appearance", "outline"], ["placeholder", "All Levels", 3, "ngModelChange", "ngModel"], [3, "value", 4, "ngFor", "ngForOf"], [1, "flex-1", "w-0"], [1, "mr-2", 3, "modelChange"], [3, "dateChange", 4, "ngIf"], [3, "value"], [3, "dateChange"]],
